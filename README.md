...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/GosiKrisztian/gos_aec_turtlesim/generate) / [`Create new repository`](https://github.com/GosiKrisztian/gos_aec_turtlesim/generate). 
...
- `gos_aec_turtlesim` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
- `GosiKrisztian` >> `mycoolusername`
